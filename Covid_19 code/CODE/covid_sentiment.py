...
BIP_GRAPH_INP='sample_data/BIP_GRAPH_INP_743_10k_low_deg_removed.gpickle'                              #bipartite graph of users and topics saved in Networkx Graph format
...
def create_deg_disc():
    ...
    A=biadjacency_matrix(BG_topic,users).toarray()    #create adjacency matrix of networkx bipartite graph
